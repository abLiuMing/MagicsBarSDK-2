...
// 本文件(fmVideoCamera.h) 部分代码参考自: https://github.com/BradLarson/GPUImage/blob/master/framework/Source/GPUImageVideoCamera.h
// 对外接口， 添加较多中文注释

#ifndef fm_fmCamera_h
#define fm_fmCamera_h
...
@protocol FMCameraDeviceOutputDelegate <NSObject>
...
@interface FMCameraDevice : NSObject<AVCaptureVideoDataOutputSampleBufferDelegate,
                                    AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    __unsafe_unretained id<FMCameraDeviceOutputDelegate> _outputDelegate;
}
...
- (id)delegate;
- (void)setDelegate: (id<FMCameraDeviceOutputDelegate>)delegate;
