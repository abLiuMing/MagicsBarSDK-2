...
@interface FMCVUtilTexture : NSObject
...
@interface FMCVUtilTextureWithFramebuffer : FMCVUtilTexture
...
- (FMCVBufferData)mapBuffer:(CVPixelBufferLockFlags)lockFlag;
