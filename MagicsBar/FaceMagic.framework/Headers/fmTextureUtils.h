...
#ifndef _FMTEXTUREUTILS_H_
#define _FMTEXTUREUTILS_H_

#include "fmGLFunctions.h"

#define FM_TEXTURE_DRAWER_STATIC_FUNC(cls) \
...
{\
	...
	{ \
		delete drawer; \
		drawer = nullptr; \
		FM_LOG_ERROR("create %s failed!", #cls); \
	} \
	return drawer; \
}\
...
namespace FM
{
	...
	public:
		...
		FM_TEXTURE_DRAWER_STATIC_FUNC(TextureDrawer);
	...
	protected:
		virtual FMConstString getFragmentShaderString();
		virtual FMConstString getVertexShaderString();
	};
	...
	public:
		...
		FM_TEXTURE_DRAWER_STATIC_FUNC(TextureDrawerExt);
		...
		FMSizei getBufferTexSize() { return m_texSize; }
	...
	public:
		...
		FM_TEXTURE_DRAWER_STATIC_FUNC(TextureDrawerWithMask);
	...
	private:
		...
		FMConstString getFragmentShaderString() { return nullptr; }
	...
	{
	public:
		FM_TEXTURE_DRAWER_STATIC_FUNC(TextureDrawer4ExtOES);
	...
	protected:
		...
		FMConstString getVertexShaderString();
    ...
    {
    public:
        FM_TEXTURE_DRAWER_STATIC_FUNC(TextureDrawerYUV);
...
//#undef FM_TEXTURE_DRAWER_STATIC_FUNC
